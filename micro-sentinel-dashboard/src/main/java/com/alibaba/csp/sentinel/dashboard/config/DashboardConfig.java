...
public class DashboardConfig {
     ...
     * Nacos
     */
    public static final String CONFIG_NACOS_SERVERADDR = "sentinel.dashboard.nacos.serverAddr";
    public static final String CONFIG_NACOS_NAMESPACE = "sentinel.dashboard.nacos.namespace";
    public static final String CONFIG_NACOS_GROUPID = "sentinel.dashboard.nacos.groupId";
    ...
    public static String getNacosServerAddr() {
        return getConfigStr(CONFIG_NACOS_SERVERADDR);
    }
    ...
    public static String getNacosGroupId() {
        return getConfigStr(CONFIG_NACOS_GROUPID);
    }
