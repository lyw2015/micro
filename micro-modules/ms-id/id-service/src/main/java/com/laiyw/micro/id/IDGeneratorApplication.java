package com.laiyw.micro.id;

import com.laiyw.micro.id.service.core.UidGeneratorProperties;
import com.laiyw.micro.id.service.impl.CachedUidGenerator;
import com.laiyw.micro.id.service.impl.DefaultUidGenerator;
import com.laiyw.micro.id.service.impl.DisposableWorkerIdAssigner;
...
public class IDGeneratorApplication {
    ...
    public CachedUidGenerator cachedUidGenerator() {
        ...
        generator.setRejectedPutBufferHandler((ringBuffer, uid) -> {

        });
        //  默认无需指定, 将记录日志, 并抛出UidGenerateException异常. 如有特殊需求, 请实现RejectedTakeBufferHandler接口(支持Lambda表达式)
        generator.setRejectedTakeBufferHandler(ringBuffer -> {
